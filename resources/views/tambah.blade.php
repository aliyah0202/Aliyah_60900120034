...
<html lang="en">
  <head>
    ...
    <title>Data Olahraga Populer Indonesia</title>
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.2.3/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-rbsA2VBKQhggwzxH7pPCaAqO46MgnOM80zW1RWuH61DGLwZJEdK2Kadq2F9CUG65" crossorigin="anonymous">
  </head>
  <body>
    <h2 class="text-center mt-2">Tambah Olahraga Populer</h2>
    ...
    <form action="/tambah" method="POST">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control @error('desk_singkat') is-invalid @enderror" id="desk_singkat" name="desk_singkat">
                @error('desk_singkat')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
